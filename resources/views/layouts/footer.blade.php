            ...
            <div class="row">
                <div class="col-lg-4 col-md-12 col-sm-12 mb-sm-20 mb-xs-20">
                    ...
                    <div class="newsletter-title">
                        <h1>
                            <img src="{{asset('_landing/assets/images/icon-newsletter.png')}}" alt="">
                            Send Newsletter
                        </h1>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 order-2 order-md-2 order-sm-2 order-lg-1">
                    ...
                    <div class="social-media-section">
                        ...
                        <div class="social-links">
                            <a class="facebook" href="#" data-tooltip="Facebook"><i class="fa fa-facebook"></i></a>
                            <a class="twitter" href="#" data-tooltip="Twitter"><i class="fa fa-twitter"></i></a>
                            <a class="instagram" href="#" data-tooltip="Instagram"><i class="fa fa-instagram"></i></a>
                            <a class="linkedin" href="#" data-tooltip="Linkedin"><i class="fa fa-linkedin"></i></a>
                        </div>
                    </div>
                        ...
                        <div class="contact-segments d-flex justify-content-between flex-wrap flex-lg-nowrap">
                            ...
                            <div class="single-contact d-flex mb-xs-20">
                                ...
                                <div class="contact-info">
                                    <p>Address: <span>Mayfair, Ife</span></p>
                                </div>
                            </div>
                            ...
                            <div class="single-contact d-flex mb-xs-20">
                                ...
                                <div class="contact-info">
                                    <p>Phone: <span>+2348102780566</span></p>
                                </div>
                            </div>
                            ...
                            <div class="single-contact d-flex">
                                ...
                                <div class="contact-info">
                                    <p>Email: <span>emmanueldmlr@gmail.com</span></p>
                                </div>
                            </div>
